...
#  read shape
shp <- st_read("inputs/dbnf_hex_l5.shp", quiet = TRUE) %>% 
  st_sf()
...
quickmap <- tm_shape(dnbf) +
            ...
            tm_layout(title = 'Apps demo landscapes, Daniel Boone Nf (green)')
...
for (file in unzipped_files) {
  ...
  new_file_path <- file.path("inputs", paste0("landfire_data_dbnf", file_extension))
